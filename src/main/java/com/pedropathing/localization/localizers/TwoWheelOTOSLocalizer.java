...
import static com.pedropathing.localization.constants.TwoWheelOTOSConstants.*;
 ...
 */
@Config
public class TwoWheelOTOSLocalizer extends Localizer {
     ...
     */
    public TwoWheelOTOSLocalizer(HardwareMap map) {
        this(map, new Pose());
    }
     ...
     */
    public TwoWheelOTOSLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        previousIMUOrientation = MathFunctions.normalizeAngle(otos.getPosition().h);
        deltaRadians = 0;
    }
    ...
    public void updateEncoders() {
        ...
        double currentIMUOrientation = MathFunctions.normalizeAngle(otos.getPosition().h);
